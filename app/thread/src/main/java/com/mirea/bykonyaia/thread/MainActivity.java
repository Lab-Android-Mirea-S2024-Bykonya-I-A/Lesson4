package com.mirea.bykonyaia.thread;
...
import com.mirea.bykonyaia.thread.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainThread.setName("МОЙ НОМЕР ГРУППЫ: 09, НОМЕР ПО СПИСКУ: 04, МОЙ ЛЮБИИМЫЙ ФИЛЬМ: Остров Сокровищ (не фильм, но пусть так)");
    ...
    public void OnStartBlockingCalculationInBackgroundThreadButtonPressed(View v) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Log.d("ThreadProject", String.format("Запущен поток № %d студентом группы № %s номер по списку № %d ", numberThread, "БСБО-09-21", 4));
